...
import { projectLogoAtom, projectNumberAtom, projectInfoAtom, fullRealizationAtom, projectLinkAtom, activePopupAtom } from "../../store/atoms";
...
const ProjectDetails = () => {
  ...
  return (
    <>
      <div id="project-details-anchor" className={`project-details ${activePopup ? 'show' : ''}`}>
